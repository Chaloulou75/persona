  ...
  <div class="relative bg-white">
    ...
    <lostresbotones />
      <div class="relative w-full text-gray-900">
        ...
        <nuxt-link to="/contacto" class="fixed left-0 z-40 h-auto px-4 py-2 mt-12 ml-2 tracking-widest text-gray-700 uppercase transition duration-300 ease-in-out transform rotate-45 border-2 border-gray-600 rounded shadow-lg lg:mt-64 lg:ml-48 hover:text-white hover:border-white focus:outline-none hover:bg-yellowjuli hover:-rotate-45 hover:font-semibold">Contacto</nuxt-link>

        <nuxt-link to="/resume" class="fixed right-0 z-40 h-auto px-6 py-2 mt-64 mr-2 tracking-widest text-gray-700 uppercase transition duration-300 ease-in-out transform -rotate-45 border-2 border-gray-600 rounded shadow-lg lg:mt-20 lg:mr-48 hover:text-white hover:border-white focus:outline-none hover:bg-bluejuli hover:rotate-45 hover:font-semibold">Resume
        </nuxt-link>
