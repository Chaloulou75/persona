      ...
      images : [
        {
          id: 1,
          name: 'uno',
          href: require(`~/assets/img/proyectos/pruebas/1.jpg`)
        },
        {
          id: 2,
          name: 'dos',
          href: require(`~/assets/img/proyectos/pruebas/2.jpg`)
        },
        {
          id: 3,
          name: 'tres',
          href: require(`~/assets/img/proyectos/pruebas/3.jpg`)
        },
        {
          id: 4,
          name: 'cuatro',
          href: require(`~/assets/img/proyectos/pruebas/4.jpg`)
        },
      ],
      index: null
    };
