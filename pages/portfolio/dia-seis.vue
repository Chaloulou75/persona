  ...
  <div class="relative flex flex-col w-full min-h-screen mx-auto lg:flex-row montserrat">
    ...
    <Lostresbotones />
      ...
      <div class="flex flex-col items-center justify-center w-full h-screen bg-bluejuli lg:w-1/2" @click="show = !show">
        <div class="relative w-48 h-48 mt-auto overflow-hidden leading-none text-white bg-yellowjuli ubuntu">
          <div class="absolute bottom-0 left-0 -mb-4 -ml-1 text-5xl font-bold uppercase">DÍA</div>
          <div class="absolute inset-y-0 right-0 w-1/2 mr-10 font-semibold -mt-26 text-16xl">6</div>
        </div>
      ...
      <div name="page" v-else class="relative flex flex-col w-full h-screen p-2 space-y-8 overflow-y-scroll bg-gray-200 divide-y-2 lg:w-1/2 scrollhidden">
        ...
        <div class="fixed z-10 flex flex-col w-16 px-1 space-y-2 bg-transparent">
          ...
          <div id="quinze" class="flex items-center justify-center w-full min-h-screen shadow-lg cursor-mano">
