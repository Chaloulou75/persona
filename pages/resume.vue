      ...
      <div class="flex flex-col items-center max-w-lg mx-auto my-16">
        ...
        <div class="flex flex-col justify-end max-w-sm mt-2 ml-auto space-y-8 border-l-2 border-gray-400 border-dashed">
          ...
          <div class="flex items-start">
            <div class="ml-4">
              <p class="text-lg font-bold text-gray-700">2017/ <br>2020</p>
            </div>
            <div class="px-4 pb-2">
          ...
          <div class="flex items-start">
            <div class="ml-4">
              <p class="text-lg font-bold text-gray-700">2016/ <br>2017</p>
            </div>
            <div class="px-4 pb-2">
          ...
          <div class="flex items-start">
            <div class="ml-4">
              <p class="text-lg font-bold text-gray-700">2015/ <br>2016</p>
            </div>
            <div class="px-4 pb-2">
          ...
          <div class="flex items-start">
            <div class="ml-4">
              <p class="text-lg font-bold text-gray-700">2019/ <br>HOY</p>
            </div>
            <div class="px-4 pb-2">
          ...
          <div class="flex items-start">
            <div class="ml-4">
              <p class="text-lg font-bold text-gray-700">2019</p>
            </div>
            <div class="px-4 pb-2">
          ...
          <div class="flex items-start">
            <div class="ml-4">
              <p class="text-lg font-bold text-gray-700">2018</p>
            </div>
            <div class="px-4 pb-2">
          ...
          <div class="flex items-start">
            <div class="ml-4">
              <p class="text-lg font-bold text-gray-700">2015</p>
            </div>
            <div class="px-4 pb-2">
