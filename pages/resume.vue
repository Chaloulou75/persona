        ...
        <div class="flex items-center justify-center">
          <div class="relative w-full h-screen p-2 overflow-hidden">
            ...
            <div class="relative flex flex-col items-center justify-center h-full">
              <a href="https://issuu.com/personadisenio/docs/cv2" target="_blank" class="inline-flex items-center justify-center px-5 py-3 mb-6 text-lg font-medium leading-6 tracking-wider text-gray-900 uppercase transition duration-150 ease-in-out transform border border-gray-900 rounded-lg shadow-xl hover:bg-bluejuli hover:text-white hover:translate-y-2 hover:border-white focus:outline-none focus:shadow-outline-none">
